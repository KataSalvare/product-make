...
- 功能清单
- 交互要点
- 页面级状态：复杂页面必须覆盖初始、加载、正常、空、异常；涉及权限、角色或会员等级时，还必须覆盖权限/等级不足及各变体差异
...
**需求追踪**
- 复杂页面或多页面功能必须建立 `PRD 需求 ID → SPEC 页面/区域/状态 → 验收 ID` 映射
- PRD 中的每条 Must/P0 需求必须能定位到至少一个页面承接和验收项
- SPEC 中的核心操作和页面状态必须能回溯到 PRD 需求
