    ...
    <div className="h-full bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">动态举报管理</h2>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">动态内容</th>
